...
print("🤖 Chat Bot Starting...", file=sys.stderr)
print("🤖 Chat Bot Starting...", flush=True)
...
profile_path = project_root / "Resources" / "Profile.pdf"
summary_path = project_root / "Resources" / "Personal_Summary.txt"
...
# --- Gradio UI ---
print("Starting Gradio ChatBot...", file=sys.stderr, flush=True)
print("Launching Gradio ChatInterface...", file=sys.stderr, flush=True)
interface = gr.ChatInterface(run_conversation)
print("About to launch Gradio...", file=sys.stderr, flush=True)
interface.launch(share=True, server_name="0.0.0.0", server_port=7860, show_error=True, debug=False)
print("Gradio launched!", file=sys.stderr, flush=True)